<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="ShopApp.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            <td><asp:Label ID="LabelAddCategory" runat="server">Category</asp:Label>
                <td>
                    <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                        ItemType="ShopApp.Models.Category"
                        SelectMethod="GetCategories" DateTextField="CategoryName"
                        DataValueField="CategoryID" ></asp:DropDownList>
            </td>
        </tr>
        <tr>
        <td><asp:Label ID="AddName" runat="server"> Name: </asp:Label></td>
        <td>
        ...
        <tr>
            <td><asp:Label ID="LabelAddDescripton" runat="server"></asp:Label>
                <td>
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="Shopapp.Models.Product" 
