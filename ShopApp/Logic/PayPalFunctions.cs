...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-rfl4391487081_api1.business.example.com";
    private string APIPassword = "83KLT7GBRNGAL8S7";
    private string APISignature = "Aircy62K80VnrWlhuQVB1VvDzVr1AdL6UJJoocgBjXz1Cq72kJluR5BP3";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44328/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44328/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "ShopApp  Sample Application";
        ...
        using (ShopApp.Logic.ShoppingCartActions myCartOrders = new ShopApp.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
          //  ShopApp.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
